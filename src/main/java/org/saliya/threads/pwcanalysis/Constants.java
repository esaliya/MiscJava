...
public class Constants {
    static final String PROGRAM_NAME = "MimicPairwiseClustering";
    static final char CMD_OPTION_SHORT_P ='p';
    static final String CMD_OPTION_LONG_P = "points";
    static final String CMD_OPTION_DESCRIPTION_P = "Number of data points";
